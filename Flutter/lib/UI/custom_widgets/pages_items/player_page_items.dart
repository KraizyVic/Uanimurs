                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        buttonWithCenterIcon(
                          Icons.replay_10,
                          ()=>widget.controller.seekTo(Duration(seconds: widget.controller.value.position.inSeconds - (state!.settings.player.skipDuration * 100).toInt())),
                          child: Text("${(state!.settings.player.skipDuration * 100).toInt()} sec"),
                        ),
                        SizedBox(width: 10,),
                        IconButton(
                        ...
                        buttonWithCenterIcon(
                          Icons.forward_10,
                          ()=>widget.controller.seekTo(Duration(seconds: widget.controller.value.position.inSeconds + (state!.settings.player.skipDuration * 100).toInt())),
                          child: Text("${(state!.settings.player.skipDuration * 100).toInt()} S"),
                        ),
